...
export default function Home() {
  return (
    <main className="bg-[var(--color-forest)] text-[var(--color-cream)]">
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[color:color-mix(in_srgb,var(--color-forest)_88%,black)]/90 backdrop-blur">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-6 px-6 py-4 lg:px-10">
          <a href="#" className="font-display text-xl uppercase tracking-[0.16em] text-[var(--color-mint)]">
            AgroChain AI
          </a>

          <div className="hidden items-center gap-8 text-sm text-white/72 md:flex">
            {navItems.map((item) => (
              <a key={item.label} href={item.href} className="transition hover:text-[var(--color-cream)]">
                {item.label}
              </a>
            ))}
          </div>
          ...
          <a
            href="#waitlist"
            className="inline-flex items-center gap-2 rounded-full bg-[var(--color-mint)] px-5 py-3 text-sm font-semibold text-[var(--color-ink)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_40px_rgba(46,204,113,0.28)]"
          >
            Get Early Access
            <ArrowUpRight />
          </a>
      ...
      <section className="hero-shell section-reveal relative isolate overflow-hidden">
        ...
        <div className="mx-auto flex min-h-[calc(100vh-73px)] w-full max-w-7xl flex-col items-center justify-center px-6 py-16 text-center lg:px-10 lg:py-20">
          <div className="section-reveal flex w-full max-w-6xl flex-col items-center gap-8">
            <div className="inline-flex w-fit items-center gap-3 rounded-full border border-[var(--color-gold)]/45 bg-[var(--color-gold)]/10 px-4 py-2 text-xs uppercase tracking-[0.24em] text-[var(--color-gold)]">
              <span className="live-dot h-2.5 w-2.5 rounded-full bg-[var(--color-mint)]" />
              Farmers Point
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="hero-editorial relative mx-auto mt-2 w-full max-w-6xl">
                <div className="hero-collage-card absolute left-[1%] top-[60%] z-10 hidden w-52 -rotate-[5deg] rounded-[1.6rem] border border-white/18 bg-[linear-gradient(135deg,rgba(250,250,245,0.96),rgba(233,245,226,0.92))] p-4 text-left shadow-[0_30px_90px_rgba(0,0,0,0.26)] lg:block">
                  <p className="text-[0.65rem] uppercase tracking-[0.28em] text-[var(--color-forest)]/55">Escrow Lock</p>
                  <div className="mt-4 rounded-[1.2rem] bg-[linear-gradient(135deg,var(--color-mint),#86efac)] p-4 text-[var(--color-ink)]">
                    <p className="text-2xl font-display uppercase tracking-[-0.05em]">Protected</p>
                    <p className="mt-2 text-sm leading-5 text-[var(--color-ink)]/74">Payment secured until delivery confirmation.</p>
                  </div>
                </div>

                {/* <div className="hero-collage-icon absolute left-[7%] top-[58%] z-20 hidden h-28 w-28 -rotate-[16deg] items-center justify-center rounded-[1.6rem] border border-[var(--color-gold)]/32 bg-[var(--color-gold)] text-[var(--color-forest)] shadow-[0_20px_60px_rgba(0,0,0,0.24)] lg:flex">
                ...
                <div className="hero-collage-card absolute right-[1%] top-[44%] z-10 hidden w-56 rotate-[4deg] rounded-[1.6rem] border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.04))] p-4 text-left backdrop-blur-sm shadow-[0_30px_90px_rgba(0,0,0,0.26)] lg:block">
                  ...
                  <p className="mt-4 font-display text-5xl uppercase tracking-[-0.05em] text-[var(--color-mint)]">82</p>
                ...
                <h1 className="font-display relative z-0 mx-auto max-w-6xl text-[4.25rem] uppercase leading-[0.86] tracking-[-0.08em] text-[var(--color-mint)] sm:text-[5.6rem] lg:text-[8rem] xl:text-[10rem]">
                  Turn Trade
                  <br />
                  Into Trust
                </h1>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <a
                href="#features"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--color-mint)] px-7 py-4 text-sm font-semibold text-[var(--color-ink)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(46,204,113,0.28)]"
              >
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/22 px-7 py-4 text-sm font-semibold text-[var(--color-cream)] transition duration-300 hover:-translate-y-1 hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]"
              >
                Watch Demo
                <ArrowUpRight />
              </a>
      ...
      <section className="section-reveal border-t border-white/8 bg-[var(--color-ink)] px-6 py-24 lg:px-10">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-12">
          <div className="max-w-4xl">
            <p className="font-display text-4xl uppercase leading-tight tracking-[-0.04em] text-[var(--color-gold)] sm:text-5xl lg:text-6xl">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {problemCards.map((card) => (
              <article
                key={card.title}
                className="lift-card rounded-[1.75rem] border border-[var(--color-gold)]/35 bg-[var(--color-forest)] p-6"
              >
                <div className="mb-8 flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--color-gold)]/12 text-[var(--color-gold)]">
                  <SimpleIcon />
                </div>
                <h2 className="font-display text-2xl uppercase tracking-[-0.03em] text-[var(--color-cream)]">
                  {card.title}
                </h2>
      ...
      <section id="features" className="section-reveal bg-[var(--color-cream)] px-6 py-24 text-[var(--color-forest)] lg:px-10">
        <div className="mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div className="space-y-6">
            ...
            <p className="max-w-xl text-lg leading-8 text-[var(--color-forest)]/74">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {featureTags.map((feature) => (
              <div
                key={feature}
                className="rounded-[1.5rem] border border-[var(--color-forest)]/10 bg-white px-5 py-6 shadow-[0_18px_50px_rgba(13,59,30,0.08)]"
              >
                <div className="flex items-center gap-4">
                  <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[var(--color-mint)]/14 text-[var(--color-forest)]">
                    <SimpleIcon />
                  </span>
      ...
      <section id="how-it-works" className="section-reveal overflow-hidden bg-[var(--color-forest)] px-6 py-24 lg:px-10">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-10">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-[var(--color-gold)]">Phased Rollout</p>
              <h2 className="font-display mt-4 text-5xl uppercase leading-[0.96] tracking-[-0.05em] text-[var(--color-cream)] sm:text-6xl">
          ...
          <div className="flex snap-x gap-5 overflow-x-auto pb-4 hide-scrollbar">
            {phases.map((phase) => (
              <article
                key={phase.number}
                className="lift-card min-w-[19rem] snap-start rounded-[1.75rem] border border-white/10 bg-[var(--color-ink)]/72 p-6 sm:min-w-[22rem] lg:min-w-[24rem]"
              >
                <p className="text-sm font-semibold tracking-[0.3em] text-[var(--color-gold)]">{phase.number}</p>
                <h3 className="mt-4 font-display text-3xl uppercase tracking-[-0.04em] text-[var(--color-cream)]">
                  {phase.title}
                </h3>
                <ul className="mt-6 space-y-4 text-sm leading-7 text-white/72">
                  {phase.bullets.map((bullet) => (
                    <li key={bullet} className="flex gap-3">
                      <span className="mt-2 h-2 w-2 flex-none rounded-full bg-[var(--color-mint)]" />
                      <span>{bullet}</span>
                    </li>
                  ))}
                </ul>
      ...
      <section id="impact" className="section-reveal bg-[var(--color-cream)] px-6 py-24 text-[var(--color-forest)] lg:px-10">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-10">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
            ...
            <p className="max-w-lg text-base leading-7 text-[var(--color-forest)]/74">
              ...
              <article
                ...
                className={`rounded-[1.75rem] p-8 ${
                  index % 2 === 0
                    ...
                    : "border border-[var(--color-forest)]/10 bg-white text-[var(--color-forest)]"
                }`}
              >
                <p
                  className={`text-sm uppercase tracking-[0.3em] ${
                    index % 2 === 0 ? "text-[var(--color-gold)]" : "text-[var(--color-gold-deep)]"
                  }`}
                >
                  Stakeholder
                </p>
                <h3 className="mt-5 font-display text-4xl uppercase tracking-[-0.04em]">{card.title}</h3>
                <p className={`mt-5 max-w-md text-base leading-7 ${index % 2 === 0 ? "text-white/74" : "text-[var(--color-forest)]/74"}`}>
                  {card.copy}
                </p>
              </article>
            ))}
      ...
      <section className="section-reveal border-y border-white/8 bg-[var(--color-ink)] px-6 py-16 lg:px-10">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <h2 className="font-display text-5xl uppercase tracking-[-0.05em] text-[var(--color-cream)] sm:text-6xl">
              Built to scale.
            </h2>
            <p className="max-w-lg text-base leading-7 text-white/66">
          ...
          <div className="flex flex-wrap gap-3">
            {revenueStreams.map((stream) => (
              <div
                key={stream}
                className="rounded-full border border-[var(--color-gold)]/45 px-5 py-3 text-sm uppercase tracking-[0.16em] text-[var(--color-gold)]"
              >
                {stream}
              </div>
            ))}
      ...
      <section className="overflow-hidden border-b border-white/8 bg-[var(--color-forest)] py-8">
        <div className="marquee-track flex min-w-max items-center gap-10 whitespace-nowrap font-display text-4xl uppercase tracking-[-0.05em] text-[var(--color-mint)] sm:text-5xl lg:text-6xl">
      ...
      <footer id="team" className="section-reveal bg-[var(--color-ink)] px-6 py-16 lg:px-10">
        <div className="mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-[1fr_0.55fr_0.95fr]">
          <div className="space-y-5">
            <a href="#" className="font-display text-2xl uppercase tracking-[0.14em] text-[var(--color-mint)]">
              AgroChain AI
            </a>
            ...
            <div className="flex gap-3">
              {socials.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="inline-flex h-11 items-center justify-center rounded-full border border-white/10 px-4 text-sm text-white/74 transition hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]"
                >
                  {item.label}
                </a>
              ))}
          ...
          <div id="waitlist" className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6">
            <p className="text-sm uppercase tracking-[0.26em] text-[var(--color-gold)]">Join the waitlist</p>
            <h3 className="mt-4 font-display text-3xl uppercase tracking-[-0.04em] text-[var(--color-cream)]">
            ...
            <form className="mt-6 flex flex-col gap-3 sm:flex-row">
              <input
                ...
                className="h-13 w-full rounded-full border border-white/10 bg-[var(--color-forest)] px-5 text-sm text-[var(--color-cream)] outline-none placeholder:text-white/34 focus:border-[var(--color-mint)]"
              />
              <button
                type="submit"
                className="inline-flex h-13 items-center justify-center rounded-full bg-[var(--color-mint)] px-6 text-sm font-semibold text-[var(--color-ink)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_42px_rgba(46,204,113,0.24)]"
              >
                Join Waitlist
              </button>
            </form>
